...
import com.danmuku.maker.customview.drawable.EditableDrawable;
import com.danmuku.maker.customview.drawable.FeatherDrawable;
...
public class MyImageViewDrawableOverlay extends ImageViewTouch {
    ...
    public static interface OnDrawableEventListener {
        ...
        //长按标签事件处理
        void onLongClick(LabelView label);
    }
        ...
        if (currentLabel != null) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    if (isLongPressed(downLabelX, downLabelY, upX, upY, event.getDownTime(), event.getEventTime(), 500)) {
                        mDrawableListener.onLongClick(currentLabel);
                    } else {
